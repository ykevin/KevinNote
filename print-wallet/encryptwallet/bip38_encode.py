...
import hashlib, re, sys, os, base64, time, random, hmac, scrypt, binascii, base58
import ripemd
...
G = (Gx,Gy)
PRIV =  "/home/pi/.wallet/priv.ini"
PASSWD =  "/home/pi/.wallet/passwd.ini"
...
def get_privkey():
    for priv in open(PRIV):
   	priv = priv.strip()
#        print "python priv: ", priv
    for passwd in open(PASSWD):
        passwd = passwd.strip()
#        print "python passwd: ", passwd
    bip38_privkey = bip38_encrypt(priv, passwd)
    return bip38_privkey
